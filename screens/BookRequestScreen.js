...
export default class BookRequestScreen extends Component{
  ...
  async getBooksFromApi(bookName){
    ...
    if(bookName.length>2){
      var books = await BookSearch(bookName,"AIzaSyBUkvDNxBnzMVuolvg9RbqCbey6XXhFHZI")
  ...
  renderItem=({item,i})=>{
    return(
      <TouchableHighlight style={{
        alignItems:'center', 
        backgroundColor: '#F27B9E',
        padding: 10,
        width: '90%'
      }}
        activeOpacity={0.7}
        underlayColor='#F27B9E'
        onPress={()=>{
          this.setState({
            showFlatlist: false,
  ...
  addRequest = async (bookName,reasonToRequest)=>{
    ...
    var books = await BookSearch.searchbook(bookName,'AIzaSyBUkvDNxBnzMVuolvg9RbqCbey6XXhFHZI')
